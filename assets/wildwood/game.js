(function() {
  ...
  (() => {
    ...
    function renderInventory() {
      ...
      equippedFeetSlot.innerHTML = inventory.equippedFeet === TRAILBLAZER_BOOTS ? `<span class="boot-pixel-icon" aria-hidden="true"><i></i><i></i></span><span>FEET</span>` : "<span>FEET</span>";
