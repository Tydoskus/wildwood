...
const MAP_GUIDE_THEMES: Record<MapId, { ground: string; path: string; glow: string }> = {
  ...
  [CRYSTAL_HOLLOWS_MAP_ID]: { ground: "#303347", path: "#626781", glow: "#c3a6ff" }, [CLOCKWORK_RUINS_MAP_ID]: { ground: "#303347", path: "#626781", glow: "#c3a6ff" }, [DUSKFALL_ORCHARD_MAP_ID]: { ground: "#303347", path: "#626781", glow: "#c3a6ff" },
};
