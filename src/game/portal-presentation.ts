...
const PORTAL_DESTINATION_COLORS: Record<MapId, string> = {
  ...
  [CRYSTAL_HOLLOWS_MAP_ID]: "#c3a6ff", [CLOCKWORK_RUINS_MAP_ID]: "#e3b964", [DUSKFALL_ORCHARD_MAP_ID]: "#b8df82", [NEON_BASTION_MAP_ID]: "#56f7ff", [VERDANT_CATACOMBS_MAP_ID]: "#56f7ff", [ION_CITADEL_MAP_ID]: "#56f7ff",
};
