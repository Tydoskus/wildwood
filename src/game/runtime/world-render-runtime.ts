...
export function createWorldRenderRuntime(options: WorldRenderRuntimeOptions) {
  ...
  const world = createWorldRenderer({
    ...
    crystalHollowsMapId: options.crystalHollowsMapId, clockworkRuinsMapId: options.clockworkRuinsMapId, duskfallOrchardMapId: options.duskfallOrchardMapId, neonBastionMapId: options.neonBastionMapId,
    paths: options.paths,
    decor: options.decor,
    ...
    prismshellBoss: options.prismshellBoss, ironhornBoss: options.ironhornBoss, dreadreaperBoss: options.dreadreaperBoss, voltwardenBoss: options.voltwardenBoss,
                  ...
                  : options.currentMapId() === options.cloudspireMapId
                    ...
                    : options.currentMapId() === options.moonfenMapId
                      ...
                      : options.currentMapId() === options.crystalHollowsMapId
                        ...
                        : options.currentMapId() === options.clockworkRuinsMapId ? options.ironhornBoss : options.currentMapId() === options.neonBastionMapId ? options.voltwardenBoss : options.currentMapId() === options.duskfallOrchardMapId ? options.dreadreaperBoss : null,
  ...
  function createFrameRenderer(frame: FrameRendererOptions): RenderController {
    ...
    const depth = createDepthWorldRenderer({
      ...
      drawPrismshellBoss: boss.drawPrismshellBoss, drawIronhornBoss: boss.drawIronhornBoss, drawDreadreaperBoss: boss.drawDreadreaperBoss, drawVoltwardenBoss: boss.drawVoltwardenBoss,
    ...
    renderer = createRenderController({
      ...
      drawPrismshellTelegraphs: boss.drawPrismshellTelegraphs, drawIronhornTelegraphs: boss.drawIronhornTelegraphs, drawDreadreaperTelegraphs: boss.drawDreadreaperTelegraphs, drawVoltwardenTelegraphs: boss.drawVoltwardenTelegraphs,
      ...
      currentMapIsCrystalHollows: () => options.currentMapId() === options.crystalHollowsMapId, currentMapIsClockworkRuins: () => options.currentMapId() === options.clockworkRuinsMapId, currentMapIsDuskfallOrchard: () => options.currentMapId() === options.duskfallOrchardMapId, currentMapIsNeonBastion: () => options.currentMapId() === options.neonBastionMapId,
