...
import {
  ...
  ADVANCED_LAVA_WASTES_BOSS_REWARD_SCALE,
  ...
  INFERNAL_DEPTHS_BOSS_REWARD_SCALE,
  ...
  SAMURAI_GARDEN_BOSS_REWARD_SCALE,
  MAGMALISK_MAX_HP,
  ...
  MOONFEN_BOSS_REWARD_SCALE,
  MOONFEN_HEALTH_REWARD_MULTIPLIER,
  CRYSTAL_HOLLOWS_REWARD_SCALE,
  CRYSTAL_HOLLOWS_BOSS_REWARD_SCALE,
  CRYSTAL_HOLLOWS_HEALTH_REWARD_MULTIPLIER,
...
describe("Magmalisk boss", () => {
  it("follows the shared Lava Lake boss health and four-stat reward budget", () => {
    ...
    expect(MAGMALISK_REWARD_DAMAGE).toBe(14_400_000_000 * ADVANCED_LAVA_WASTES_REWARD_SCALE * ADVANCED_LAVA_WASTES_DAMAGE_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_SCALE);
    expect(MAGMALISK_REWARD_HEALTH).toBe(81_945_000_000 * ADVANCED_LAVA_WASTES_REWARD_SCALE * ADVANCED_LAVA_WASTES_HEALTH_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_SCALE);
    expect(MAGMALISK_REWARD_ARMOR).toBe(7_000_000 * ADVANCED_LAVA_WASTES_REWARD_SCALE * ADVANCED_LAVA_WASTES_BOSS_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_SCALE);
    expect(MAGMALISK_REWARD_REGEN).toBe(405_015_625 * ADVANCED_LAVA_WASTES_REWARD_SCALE * ADVANCED_LAVA_WASTES_BOSS_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_SCALE);
  });
...
describe("Gloomroot boss", () => {
  it("caps Night Forest with a four-stat Water Reach unlock reward", () => {
    ...
    expect(GLOOMROOT_REWARD_DAMAGE).toBe(120_000_000_000 * INFERNAL_DEPTHS_BOSS_REWARD_MULTIPLIER * INFERNAL_DEPTHS_DAMAGE_REWARD_MULTIPLIER * INFERNAL_DEPTHS_BOSS_REWARD_SCALE);
    expect(GLOOMROOT_REWARD_HEALTH).toBe(250_000_000_000 * INFERNAL_DEPTHS_BOSS_REWARD_MULTIPLIER * INFERNAL_DEPTHS_HEALTH_REWARD_MULTIPLIER * INFERNAL_DEPTHS_BOSS_REWARD_SCALE);
    expect(GLOOMROOT_REWARD_ARMOR).toBe(10_000_000 * INFERNAL_DEPTHS_BOSS_REWARD_MULTIPLIER * INFERNAL_DEPTHS_BOSS_REWARD_SCALE);
    expect(GLOOMROOT_REWARD_REGEN).toBe(2_000_000_000 * INFERNAL_DEPTHS_BOSS_REWARD_MULTIPLIER * INFERNAL_DEPTHS_BOSS_REWARD_SCALE);
  });
...
describe("Tidewyrm boss", () => {
  it("caps Water Reach with the scaled Samurai Garden unlock reward", () => {
    ...
    expect(TIDEWYRM_REWARD_DAMAGE).toBe(GLOOMROOT_REWARD_DAMAGE * SAMURAI_GARDEN_REWARD_SCALE * WATER_REACH_DAMAGE_REWARD_MULTIPLIER * WATER_REACH_BOSS_REWARD_SCALE);
    expect(TIDEWYRM_REWARD_HEALTH).toBe(GLOOMROOT_REWARD_HEALTH * SAMURAI_GARDEN_REWARD_SCALE * WATER_REACH_HEALTH_REWARD_MULTIPLIER * WATER_REACH_BOSS_REWARD_SCALE);
    expect(TIDEWYRM_REWARD_ARMOR).toBe(GLOOMROOT_REWARD_ARMOR * SAMURAI_GARDEN_REWARD_SCALE * WATER_REACH_BOSS_REWARD_SCALE);
    expect(TIDEWYRM_REWARD_REGEN).toBe(GLOOMROOT_REWARD_REGEN * SAMURAI_GARDEN_REWARD_SCALE * WATER_REACH_BOSS_REWARD_SCALE);
  });
...
describe("Koi Shogun boss", () => {
  it("caps Samurai Garden with a repeatable late-map reward", () => {
    expect(KOI_SHOGUN_MAX_HP).toBe(TIDEWYRM_MAX_HP * BALANCE_TARGET_MAP_POWER_MULTIPLIER * .75);
    expect(KOI_SHOGUN_REWARD_DAMAGE).toBe(TIDEWYRM_REWARD_DAMAGE * SAMURAI_GARDEN_REWARD_SCALE * SAMURAI_GARDEN_BOSS_REWARD_SCALE);
    expect(KOI_SHOGUN_REWARD_HEALTH).toBe(TIDEWYRM_REWARD_HEALTH * SAMURAI_GARDEN_REWARD_SCALE * SAMURAI_GARDEN_BOSS_REWARD_SCALE);
    expect(KOI_SHOGUN_REWARD_ARMOR).toBe(TIDEWYRM_REWARD_ARMOR * SAMURAI_GARDEN_REWARD_SCALE * SAMURAI_GARDEN_BOSS_REWARD_SCALE);
    expect(KOI_SHOGUN_REWARD_REGEN).toBe(TIDEWYRM_REWARD_REGEN * SAMURAI_GARDEN_REWARD_SCALE * SAMURAI_GARDEN_BOSS_REWARD_SCALE);
  });
...
describe("Tempest Kirin boss", () => {
  it("caps Cloudspire with the next repeatable late-map reward", () => {
    expect(TEMPEST_KIRIN_MAX_HP).toBe(KOI_SHOGUN_MAX_HP * BALANCE_TARGET_MAP_POWER_MULTIPLIER * 1.1);
    expect(TEMPEST_KIRIN_REWARD_DAMAGE).toBe(KOI_SHOGUN_REWARD_DAMAGE * CLOUDSPIRE_REWARD_SCALE * CLOUDSPIRE_DAMAGE_REWARD_MULTIPLIER * CLOUDSPIRE_BOSS_REWARD_SCALE);
    expect(TEMPEST_KIRIN_REWARD_HEALTH).toBe(KOI_SHOGUN_REWARD_HEALTH * CLOUDSPIRE_REWARD_SCALE * CLOUDSPIRE_HEALTH_REWARD_MULTIPLIER * CLOUDSPIRE_BOSS_REWARD_SCALE);
    expect(TEMPEST_KIRIN_REWARD_ARMOR).toBe(KOI_SHOGUN_REWARD_ARMOR * CLOUDSPIRE_REWARD_SCALE * CLOUDSPIRE_BOSS_REWARD_SCALE);
    expect(TEMPEST_KIRIN_REWARD_REGEN).toBe(KOI_SHOGUN_REWARD_REGEN * CLOUDSPIRE_REWARD_SCALE * CLOUDSPIRE_BOSS_REWARD_SCALE);
  });
...
describe("Miremaw boss", () => {
  it("caps Moonfen with the next repeatable late-map reward", () => {
    expect(MIREMAW_MAX_HP).toBe(TEMPEST_KIRIN_MAX_HP * BALANCE_TARGET_MAP_POWER_MULTIPLIER * 1.1);
    expect(MIREMAW_REWARD_DAMAGE).toBe(TEMPEST_KIRIN_REWARD_DAMAGE * MOONFEN_REWARD_SCALE * MOONFEN_BOSS_REWARD_SCALE);
    expect(MIREMAW_REWARD_HEALTH).toBe(TEMPEST_KIRIN_REWARD_HEALTH * MOONFEN_REWARD_SCALE * MOONFEN_HEALTH_REWARD_MULTIPLIER * MOONFEN_BOSS_REWARD_SCALE);
    expect(MIREMAW_REWARD_ARMOR).toBe(TEMPEST_KIRIN_REWARD_ARMOR * MOONFEN_REWARD_SCALE * MOONFEN_BOSS_REWARD_SCALE);
    expect(MIREMAW_REWARD_REGEN).toBe(TEMPEST_KIRIN_REWARD_REGEN * MOONFEN_REWARD_SCALE * MOONFEN_BOSS_REWARD_SCALE);
  });
...
describe("Prismshell boss", () => {
  it("continues the full progression step after Miremaw", () => {
    expect(PRISMSHELL_MAX_HP).toBe(MIREMAW_MAX_HP * BALANCE_TARGET_MAP_POWER_MULTIPLIER * 1.1);
    expect(PRISMSHELL_REWARD_DAMAGE).toBe(MIREMAW_REWARD_DAMAGE * CRYSTAL_HOLLOWS_REWARD_SCALE * CRYSTAL_HOLLOWS_BOSS_REWARD_SCALE);
    expect(PRISMSHELL_REWARD_HEALTH).toBe(MIREMAW_REWARD_HEALTH * CRYSTAL_HOLLOWS_REWARD_SCALE * CRYSTAL_HOLLOWS_HEALTH_REWARD_MULTIPLIER * CRYSTAL_HOLLOWS_BOSS_REWARD_SCALE);
    expect(PRISMSHELL_REWARD_ARMOR).toBe(MIREMAW_REWARD_ARMOR * CRYSTAL_HOLLOWS_REWARD_SCALE * CRYSTAL_HOLLOWS_BOSS_REWARD_SCALE);
    expect(PRISMSHELL_REWARD_REGEN).toBe(MIREMAW_REWARD_REGEN * CRYSTAL_HOLLOWS_REWARD_SCALE * CRYSTAL_HOLLOWS_BOSS_REWARD_SCALE);
  });
