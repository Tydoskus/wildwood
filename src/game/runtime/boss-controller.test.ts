...
function createFrostclawHarness(overrides: Partial<Parameters<typeof createBossController>[0]> = {}) {
  ...
  const controller = createBossController({
    ...
    getMiremawBoss: () => null,
    getPrismshellBoss: () => null, getIronhornBoss: () => null, getDreadreaperBoss: () => null, getVoltwardenBoss: () => null,
    ...
    getPrismshellResult: () => null, getIronhornResult: () => null, getDreadreaperResult: () => null, getVoltwardenResult: () => null,
    localIdentity: () => "local",
    running: () => true,
    ...
    currentMapIsCrystalHollows: () => false, currentMapIsClockworkRuins: () => false, currentMapIsDuskfallOrchard: () => false, currentMapIsNeonBastion: () => false,
