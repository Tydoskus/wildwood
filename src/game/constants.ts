...
export const DREADREAPER_AGGRO_RANGE = 775;
export const VOLTWARDEN_AGGRO_RANGE = 775;
export const GRAVEBLOOM_AGGRO_RANGE = 775;
export const AEGIS_PRIME_AGGRO_RANGE = 775;
export const MIREMAW_TONGUE_RANGE = 980;
export const PRISMSHELL_SHATTER_RANGE = 820;
export const IRONHORN_SHATTER_RANGE = 1100;
export const DREADREAPER_SHATTER_RANGE = 650;
export const VOLTWARDEN_SHATTER_RANGE = 650;
export const GRAVEBLOOM_SHATTER_RANGE = 650;
export const AEGIS_PRIME_SHATTER_RANGE = 650;
export const MIREMAW_TONGUE_HALF_ANGLE = .2;
export const PRISMSHELL_SHATTER_HALF_ANGLE = .38;
export const IRONHORN_SHATTER_HALF_ANGLE = .24;
export const DREADREAPER_SHATTER_HALF_ANGLE = 1.15;
export const VOLTWARDEN_SHATTER_HALF_ANGLE = 1.15;
export const GRAVEBLOOM_SHATTER_HALF_ANGLE = 1.15;
export const AEGIS_PRIME_SHATTER_HALF_ANGLE = 1.15;
export const MIREMAW_SPRITE_Y_OFFSET = -45;
export const PRISMSHELL_SPRITE_Y_OFFSET = 0;
export const IRONHORN_SPRITE_Y_OFFSET = 0;
export const DREADREAPER_SPRITE_Y_OFFSET = 0;
