export const RELEASE_NOTES: Record<string, string[]> = {
  ...
  "0.801": [
    ...
    "Damage numbers from several hits spread out so each one is readable.",
    "Enemy health bars flash only the health just lost, like boss bars.",
  ],
  "0.800": [
  ...
  "0.782": [
    ...
    "Chasing enemies keep up with you again.",
    "Miremaw, the Koi Shogun and the Tempest Kirin are hit where you can see them.",
    "Two boss name plates no longer float above their heads.",
    "Every Samurai Garden tree has its shadow back.",
    "The sign-in screen says alpha, and links the Discord.",
  ],
  "0.781": [
    "Upgrades belong to your Weapon, Helmet and Armor slots now, and run to tier 35.",
    "Each slot started at the highest level any item in it had reached.",
    "Item stats grow with the map they come from: map 15 gear is worth twice what it was.",
    "Tier numbers are off items and on slots.",
  ],
  "0.780": [
    "The leaderboard is grouped by prestige, highest first.",
    "The leaderboard unlocks when you defeat the Dragon.",
    "Tidier name plate above players.",
  ],
  "0.779": [
    "Multiplayer starts off every sign-in, until you tap the eye.",
    "The overhead health bar is back to its old height.",
    "Report and Block moved into a profile's INFO tab.",
  ],
  "0.778": [
    "Tidied the overhead name plate.",
  ],
  "0.777": [
    "The Basic Paper Hat is a rare forest drop rather than a starting item.",
    "Trailblazer Boots removed. Bare feet take your skin tone.",
  ],
  "0.776": [
    "Chasing enemies are slightly faster than you, not slower.",
    "Your age confirmation follows your account to other devices.",
    "The tutorial arrow points at your Profile HUD.",
  ],
  "0.775": [
    "Coming back to the window interrupts you less often.",
  ],
  "0.774": [
    "A hidden tab gets two minutes before returning counts as waking up.",
  ],
  "0.773": [
    "Fixed Prestige refusing a prestige you had earned.",
  ],
  "0.772": [
    "Fixed the Upgrade Bench list: stretched tabs and a Back button off the bottom.",
    "The Upgrade Bench list is sorted by tier, highest first.",
    "Settings › Account has an OFFLINE PROGRESS switch.",
    "Fixed being put back at a portal after an update.",
  ],
  "0.771": [
    "Confirmations are the game's own window now, not the browser's.",
    "Gem prompts show the cost, your balance and what is left.",
    "The Upgrade Bench list shows tiers, with ALL / WEAPON / HELMET / ARMOR tabs.",
    "The Prestige button moved beside STATS and INFO, and greys out until you qualify.",
    "Prestige asks “Yes, prestige”, and names only the Endless boss you need.",
    "Fixed prestige perk points needing several taps.",
    "The tutorial points at your Profile HUD with an arrow.",
    "Multiplayer starts off after an update.",
  ],
  "0.770": [
    "The Prestige window names the Endless stage you need.",
    "The 2× respawn reward starts running the moment you claim it.",
  ],
  "0.769": [
    "Time away pays: up to thirty minutes of farming on your best map.",
    "The 2× respawn reward is a thirty-minute bank you switch on when you want it.",
    "The Travel pad is gone. The Home button is the only way in and out.",
  ],
  "0.768": [
  ...
  "0.753": [
    ...
    "Prestige resets your stats and map unlocks. You keep your equipment; higher-tier items become usable again when you reach their maps. Tech research, slot upgrades, gems and bought bag slots stay.",
