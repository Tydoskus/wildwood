...
const bossByMap: Record<MapId, { x: number; y: number }> = {
  ...
  crystal_hollows: bootstrap.prismshellBoss, clockwork_ruins: bootstrap.ironhornBoss, duskfall_orchard: bootstrap.dreadreaperBoss, neon_bastion: bootstrap.voltwardenBoss,
};
