...
- **Health retune:** Tutorial Forest remains the onboarding baseline. From Beginner Desert onward, regular-enemy HP is 0.5× and boss HP is 2× the prior authored values; later derived maps inherit each factor once. Reward amounts and incoming damage remain separate contracts.
