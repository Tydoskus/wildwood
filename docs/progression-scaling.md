...
- canonical reward power across one regular clear is `0.425×` unsliced Water (`8.5 × 0.02 × 2.5`), or about `13.08×` one currently sliced Water clear; Koi Shogun's first clear is a separate guaranteed capstone, while later repeats do not add permanent combat stats;
