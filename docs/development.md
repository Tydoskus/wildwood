...
session after a character progress reset. A higher prestige level also starts a
new session; a temporarily missing prestige row does not. Older saved tracker
sessions get one fresh baseline if the character has already prestiged.
