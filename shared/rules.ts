...
// Forest now exits near 3.5k canonical power after the old Bramble health
// jackpot was redistributed. An 8.5x map step places the first global
// slowdown knee near 400k at the Snowlands -> Lava Lake handoff. The authored
// curve is calibrated with the balanced research queue active.
export const BALANCE_TARGET_MAP_POWER_MULTIPLIER = 8.5;
export const BALANCE_FIRST_SLOWDOWN_POWER = 400_000;
...
export const BEGINNER_DESERT_REGULAR_HEALTH_MULTIPLIER = .154;
export const BEGINNER_DESERT_BOSS_HEALTH_MULTIPLIER = .0288;
...
export const INTERMEDIATE_SNOWLANDS_REGULAR_HEALTH_MULTIPLIER = .0091;
export const INTERMEDIATE_SNOWLANDS_BOSS_HEALTH_MULTIPLIER = .0012;
...
export const ADVANCED_LAVA_WASTES_BOSS_HEALTH_MULTIPLIER = .0000858;
...
export const INFERNAL_DEPTHS_BOSS_HEALTH_MULTIPLIER = .00000594;
...
export const MAGMALISK_REWARD_DAMAGE = 14_400_000_000 * ADVANCED_LAVA_WASTES_REWARD_SCALE * ADVANCED_LAVA_WASTES_DAMAGE_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_SCALE;
export const MAGMALISK_REWARD_HEALTH = 81_945_000_000 * ADVANCED_LAVA_WASTES_REWARD_SCALE * ADVANCED_LAVA_WASTES_HEALTH_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_SCALE;
export const MAGMALISK_REWARD_ARMOR = 7_000_000 * ADVANCED_LAVA_WASTES_REWARD_SCALE * ADVANCED_LAVA_WASTES_BOSS_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_SCALE;
export const MAGMALISK_REWARD_REGEN = 405_015_625 * ADVANCED_LAVA_WASTES_REWARD_SCALE * ADVANCED_LAVA_WASTES_BOSS_REWARD_MULTIPLIER * ADVANCED_LAVA_WASTES_BOSS_REWARD_SCALE;
export const GLOOMROOT_MAX_HP = 1_150_000_000_000_000 * INFERNAL_DEPTHS_BOSS_HEALTH_MULTIPLIER;
export const GLOOMROOT_REWARD_DAMAGE = 120_000_000_000 * INFERNAL_DEPTHS_BOSS_REWARD_MULTIPLIER * INFERNAL_DEPTHS_DAMAGE_REWARD_MULTIPLIER * INFERNAL_DEPTHS_BOSS_REWARD_SCALE;
export const GLOOMROOT_REWARD_HEALTH = 250_000_000_000 * INFERNAL_DEPTHS_BOSS_REWARD_MULTIPLIER * INFERNAL_DEPTHS_HEALTH_REWARD_MULTIPLIER * INFERNAL_DEPTHS_BOSS_REWARD_SCALE;
export const GLOOMROOT_REWARD_ARMOR = 10_000_000 * INFERNAL_DEPTHS_BOSS_REWARD_MULTIPLIER * INFERNAL_DEPTHS_BOSS_REWARD_SCALE;
export const GLOOMROOT_REWARD_REGEN = 2_000_000_000 * INFERNAL_DEPTHS_BOSS_REWARD_MULTIPLIER * INFERNAL_DEPTHS_BOSS_REWARD_SCALE;
export const TIDEWYRM_MAX_HP = GLOOMROOT_MAX_HP * SAMURAI_GARDEN_HEALTH_SCALE * WATER_REACH_BOSS_HEALTH_MULTIPLIER;
export const TIDEWYRM_REWARD_DAMAGE = GLOOMROOT_REWARD_DAMAGE * SAMURAI_GARDEN_REWARD_SCALE * WATER_REACH_DAMAGE_REWARD_MULTIPLIER * WATER_REACH_BOSS_REWARD_SCALE;
export const TIDEWYRM_REWARD_HEALTH = GLOOMROOT_REWARD_HEALTH * SAMURAI_GARDEN_REWARD_SCALE * WATER_REACH_HEALTH_REWARD_MULTIPLIER * WATER_REACH_BOSS_REWARD_SCALE;
export const TIDEWYRM_REWARD_ARMOR = GLOOMROOT_REWARD_ARMOR * SAMURAI_GARDEN_REWARD_SCALE * WATER_REACH_BOSS_REWARD_SCALE;
export const TIDEWYRM_REWARD_REGEN = GLOOMROOT_REWARD_REGEN * SAMURAI_GARDEN_REWARD_SCALE * WATER_REACH_BOSS_REWARD_SCALE;
...
export const KOI_SHOGUN_REWARD_DAMAGE = TIDEWYRM_REWARD_DAMAGE * SAMURAI_GARDEN_REWARD_SCALE * SAMURAI_GARDEN_BOSS_REWARD_SCALE;
export const KOI_SHOGUN_REWARD_HEALTH = TIDEWYRM_REWARD_HEALTH * SAMURAI_GARDEN_REWARD_SCALE * SAMURAI_GARDEN_BOSS_REWARD_SCALE;
export const KOI_SHOGUN_REWARD_ARMOR = TIDEWYRM_REWARD_ARMOR * SAMURAI_GARDEN_REWARD_SCALE * SAMURAI_GARDEN_BOSS_REWARD_SCALE;
export const KOI_SHOGUN_REWARD_REGEN = TIDEWYRM_REWARD_REGEN * SAMURAI_GARDEN_REWARD_SCALE * SAMURAI_GARDEN_BOSS_REWARD_SCALE;
...
export const TEMPEST_KIRIN_REWARD_DAMAGE = KOI_SHOGUN_REWARD_DAMAGE * CLOUDSPIRE_REWARD_SCALE * CLOUDSPIRE_DAMAGE_REWARD_MULTIPLIER * CLOUDSPIRE_BOSS_REWARD_SCALE;
export const TEMPEST_KIRIN_REWARD_HEALTH = KOI_SHOGUN_REWARD_HEALTH * CLOUDSPIRE_REWARD_SCALE * CLOUDSPIRE_HEALTH_REWARD_MULTIPLIER * CLOUDSPIRE_BOSS_REWARD_SCALE;
export const TEMPEST_KIRIN_REWARD_ARMOR = KOI_SHOGUN_REWARD_ARMOR * CLOUDSPIRE_REWARD_SCALE * CLOUDSPIRE_BOSS_REWARD_SCALE;
export const TEMPEST_KIRIN_REWARD_REGEN = KOI_SHOGUN_REWARD_REGEN * CLOUDSPIRE_REWARD_SCALE * CLOUDSPIRE_BOSS_REWARD_SCALE;
...
export const PRISMSHELL_REWARD_HEALTH = MIREMAW_REWARD_HEALTH * CRYSTAL_HOLLOWS_REWARD_SCALE * CRYSTAL_HOLLOWS_HEALTH_REWARD_MULTIPLIER * CRYSTAL_HOLLOWS_BOSS_REWARD_SCALE;
export const MIREMAW_REWARD_ARMOR = TEMPEST_KIRIN_REWARD_ARMOR * MOONFEN_REWARD_SCALE * MOONFEN_BOSS_REWARD_SCALE;
export const PRISMSHELL_REWARD_ARMOR = MIREMAW_REWARD_ARMOR * CRYSTAL_HOLLOWS_REWARD_SCALE * CRYSTAL_HOLLOWS_BOSS_REWARD_SCALE;
export const MIREMAW_REWARD_REGEN = TEMPEST_KIRIN_REWARD_REGEN * MOONFEN_REWARD_SCALE * MOONFEN_BOSS_REWARD_SCALE;
export const PRISMSHELL_REWARD_REGEN = MIREMAW_REWARD_REGEN * CRYSTAL_HOLLOWS_REWARD_SCALE * CRYSTAL_HOLLOWS_BOSS_REWARD_SCALE;
