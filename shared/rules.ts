...
export const GRAVEBLOOM_MAX_HP = bossHealthAt(13);
export const AEGIS_PRIME_MAX_HP = bossHealthAt(14);
...
export const GRAVEBLOOM_REWARD_DAMAGE = bossRewardAt("damage", 13);
export const AEGIS_PRIME_REWARD_DAMAGE = bossRewardAt("damage", 14);
...
export const GRAVEBLOOM_REWARD_HEALTH = bossRewardAt("health", 13);
export const AEGIS_PRIME_REWARD_HEALTH = bossRewardAt("health", 14);
...
export const GRAVEBLOOM_REWARD_ARMOR = bossRewardAt("armor", 13);
export const AEGIS_PRIME_REWARD_ARMOR = bossRewardAt("armor", 14);
...
export const GRAVEBLOOM_REWARD_REGEN = bossRewardAt("regen", 13);
export const AEGIS_PRIME_REWARD_REGEN = bossRewardAt("regen", 14);
