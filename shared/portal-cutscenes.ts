...
export type PortalUnlockProgress = Partial<Record<(typeof PORTAL_CUTSCENES)[number]["unlock"] | "cloudspireUnlocked" | "moonfenUnlocked" | "crystalHollowsUnlocked" | "clockworkRuinsUnlocked" | "duskfallOrchardUnlocked" | "neonBastionUnlocked", boolean>>;
...
export function unlockedPortalCutsceneMask(progress: PortalUnlockProgress | null | undefined) {
  ...
  if (progress.neonBastionUnlocked || progress.cloudspireUnlocked || progress.moonfenUnlocked || progress.crystalHollowsUnlocked || progress.clockworkRuinsUnlocked || progress.duskfallOrchardUnlocked) return 63;
  let mask = 0;
