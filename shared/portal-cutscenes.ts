...
export type PortalUnlockProgress = Partial<Record<(typeof PORTAL_CUTSCENES)[number]["unlock"] | "cloudspireUnlocked" | "moonfenUnlocked" | "crystalHollowsUnlocked", boolean>>;
...
export function unlockedPortalCutsceneMask(progress: PortalUnlockProgress | null | undefined) {
  ...
  if (progress.cloudspireUnlocked || progress.moonfenUnlocked || progress.crystalHollowsUnlocked) return 63;
  let mask = 0;
