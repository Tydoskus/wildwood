...
// Crystal Hollows, Clockwork Ruins, Duskfall Orchard. Match Desert's farming
// time plus 20 minutes per later map, accounting for each map's camps, travel, equipment, and research.
export const CAMPAIGN_ENEMY_REWARD_MULTIPLIERS: readonly number[] = [1.0, 5.415, 1.5, 0.975, 0.799, 0.648, 0.554, 0.417, 0.362, 0.332, 0.301];
